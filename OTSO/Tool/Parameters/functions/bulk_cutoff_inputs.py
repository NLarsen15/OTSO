...
def BulkCutoffInputs():
    ...
    BulkCutoffInputArraySpace = [RigidityArray,DateArrayList,MagFieldModel,IntModel,ParticleArray,IOPTList,WindArrayList,Magnetopause,FileArrayList,CoordinateSystem,MaxStepPercent,EndParams, Station_Array, InputtedStations, CutoffComputation,  RigidityScan]
    BulkCutoffInputArrayGauss = [RigidityArray,DateArrayGauss,MagFieldModel,IntModel,ParticleArray,IOPTGauss,WindArrayGauss,Magnetopause,FileArrayGauss,CoordinateSystem,MaxStepPercent,EndParams, Station_Array, InputtedStations, CutoffComputation,  RigidityScan, GaussCoeffs]

    return BulkCutoffInputArraySpace, BulkCutoffInputArrayGauss
