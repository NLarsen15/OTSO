...
def OTSO_cutoff_bulk():
    ...
    if Bulkcomp == 0:
        ...
        for File, Gauss in zip(FileDescriptorsListGauss, GaussCoeffs):
            ...
            LiveData = 0
            readme_generators.READMECutoff(Station_Array, RigidityArray, EventDate, Model, IntModel, AtomicNum, AntiCheck, IOPTGauss, WindGauss, Magnetopause, File, CoordinateSystem, Printtime, MaxStepPercent*100, EndParams, Rcomp, Rscan, LiveData)
