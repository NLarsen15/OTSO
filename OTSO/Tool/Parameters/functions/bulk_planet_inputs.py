...
def BulkPlanetInputs():
    ...
    IOPTGauss = 1
    FileArrayGauss = FileprocessGauss(FileGaussStringList)
    ...
    FileArrayList = Fileprocess(TimeString)
    ...
    BulkPlanetInputArraySpace = [LongitudeList,LatitudeList,RigidityArray,DateArrayList,MagFieldModel,IntModel,ParticleArray,IOPTList,WindArrayList,Magnetopause,FileArrayList,MaxStepPercent,EndParams,CutoffComputation,RigidityScan]
    BulkPlanetInputArrayGauss = [LongitudeList,LatitudeList,RigidityArray,DateArrayGauss,MagFieldModel,IntModel,ParticleArray,IOPTGauss,WindArrayGauss,Magnetopause,FileArrayGauss,MaxStepPercent,EndParams,CutoffComputation,RigidityScan, GaussCoeffs]

    return BulkPlanetInputArraySpace, BulkPlanetInputArrayGauss
...
def Fileprocess(FileStringList):
    ...
    for string in FileStringList:
        ...
        FileArray = [FolderNameFinal, final_directory]
        FileArrayList.append(FileArray)

    return FileArrayList 

def FileprocessGauss(FileGaussStringList):
