...
output_directory = './Parameters/data_files'  
...
def Get_Data(current_time):
    ...
    Dst,daily_dst = extract_dst_value('./Parameters/data_files/Dst_data.txt', current_time)
    ...
    return Dst, Speed, Density, By, Bz, IOPT, G1, G2, G3 
