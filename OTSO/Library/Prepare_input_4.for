...
c
      SUBROUTINE PREPAREINPUT4(OMNIYEAR)
      USE GEOPACK1
     ...
     * IMFFLAG(105408),ISWFLAG(105408)
      ...
      WRITE(LISTNAME, '(I0, "_Interval_list.txt")') IYEAR
      WRITE(NAMEOUT, '(I0, "_OMNI_5m_with_TS05_variables.dat")') IYEAR
      
C
      OPEN (UNIT=1,FILE='Parameters/functions/Parameters.par')
